/* ============================================================
   ...
   ============================================================
   ⚠️ SIN PRECIOS Y CARTA CORTA. No publican carta en ningún canal. Los
   productos listados son SOLO los que nombran sus reseñas reales y los que
   se ven en sus propias fotos: prefiero una carta corta y verdadera antes
   que una larga e inventada. Pedirles la carta completa: seguro tienen
...
const MENU = {
  "cafeteria": {
    ...
    "items": [
      {
        "n": "Café",
        "d": "\"El café maravilloso\" — cita textual de una reseña real"
      },
      {
        "n": "Chocolate caliente",
        "d": "\"El chocolate muy bueno\", dice una reseña. Va con cacao espolvoreado y malvaviscos",
        "img": "chocolate.jpg"
      },
      {
        "n": "Café con naranja",
        "d": "Bebida fría de espresso sobre jugo de naranja — fotografiada en el local",
        "img": "noche-estrellada.jpg"
      }
    ]
  },
  "salados": {
    ...
    "items": [
      {
        "n": "Sándwich en ciabatta",
        "d": "\"Los sándwiches muy ricos, en especial los de ciabatta\" — reseña real"
      },
      {
        "n": "Sándwiches",
        "d": "\"Exquisitos, tibios y crujientes\" — cita textual de otra reseña real"
      }
    ]
  }
};
